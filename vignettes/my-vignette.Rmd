...
### A. Description:
This function evaluates whether consecutive values in observations or forecasts are repeated a k number of times. This function takes in a forecast object that is either from an observed dataset or forecast dataset.
