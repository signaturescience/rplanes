...
# What to do when a flag is raised:
  ...
  - We also recommend performing a retrospective analysis of scoring and sensitivity before interpreting the `plane_score()` output to determine how many flags are "normal" for a *specific* signal being analyzed (e.g. Lyme disease vs. influenza or influenza in Florida vs. in New York).
